//
// ASCOM.AstroHibouGeminiFlatPanel.CoverCalibrator Local COM Server
//
...
namespace ASCOM.LocalServer
{
    public static class Server
    {
        ...
        private static string localServerAppId = "{72eed5f3-fb4d-4aa5-a93e-371f831504b5}"; // Our AppId
        ...
        static void Main(string[] args)
        {
            ...
            TL = new TraceLogger("", "AstroHibouGeminiFlatPanel.LocalServer")
            {
            ...
            Thread.CurrentThread.Name = "AstroHibouGeminiFlatPanel Local Server Thread";
        ...
        private static void RegisterObjects()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error while registering the server:\n" + ex.ToString(), "ASCOM.AstroHibouGeminiFlatPanel.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
        ...
        private static void ElevateSelf(string argument)
        {
            ...
            {
                TL.LogMessage("IsAdministrator", $"The ASCOM.AstroHibouGeminiFlatPanel.CoverCalibrator was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it."));
                MessageBox.Show("The ASCOM.AstroHibouGeminiFlatPanel.CoverCalibrator was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it.", "ASCOM.AstroHibouGeminiFlatPanel.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Warning));
            }
            catch (Exception ex)
            {
                TL.LogMessageCrLf("IsAdministrator", $"Exception: {ex}");
                MessageBox.Show(ex.ToString(), "ASCOM.AstroHibouGeminiFlatPanel.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            return;
        }
        ...
        private static bool RegisterClassFactories()
        {
            ...
            foreach (Type driverType in driverTypes)
            {
                ...
                if (!factory.RegisterClassObject())
                {
                    ...
                    MessageBox.Show("Failed to register class factory for " + driverType.Name, "ASCOM.AstroHibouGeminiFlatPanel.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return false;
                }
            ...
            if (args.Length > 0)
            {
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        ...
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding", "ASCOM.AstroHibouGeminiFlatPanel.CoverCalibrator", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
